
{
  ...
  "UrlUpdate": "https://raw.githubusercontent.com/Riskyzin/riskyvpn/main/config.js",
  "Sms": "https://raw.githubusercontent.com/Riskyzin/riskyvpn/main/sms.js",
  "EmailFeedback": "",
  ...
  "Servers": [
    {
      ...
      "TYPE": "premium",
      "FLAG": "br.png",
      "ServerIP": "riskyvpn.riskyzin.ml",
      "CheckUser": "http://20.197.235.228:5454/checkUser",
      "ServerPort": "22",
      "SSLPort": "443",
      "USER": "pudim",
      "PASS": "pudim"
  ...
  "Networks": [
  {
     ...
     },
    {
            "Name": "💙TIM NOVA 5",
            "FLAG": "tim",
            "Payload": "GET wss://auth.of.c6bank.com.br// HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
          ...
          },
{
                    "Name": "💙TIM imagem",
                    "FLAG": "tim",  
                    "Payload": "GET wss://image.mail.c6bank.com.br/ HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: websocket[crlf][crlf]",
                  ...
                  },
{
      "Name": "TIM TESTE [1]",
      "FLAG": "tim",
      "Payload": "GET wss://assets-sf.c6bank.com.br// HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
      "SNI": "assets-sf.c6bank.com.br",
      "TlsIP": "104.16.237.16",
      "ProxyIP": "",
      "ProxyPort": "443",
      "Info": "Tlsws"
...
{
            "Name": "VIVO CLOUDFLARE [1]",
            "FLAG": "vivo.png",
            "Payload": "GET wss://web-aceitedigital.vivo.com.br HTTP/1.1[crlf]Host: [host_port][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf][crlf]",
            "SNI": "web-aceitedigital.vivo.com.br",
            "TlsIP": "104.18.8.80",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
        ...
        {
            "Name": "VIVO CLOUDFLARE [2]",
            "FLAG": "vivo.png",
            "Payload": "GET wss://lojaempresas.vivo.com.br HTTP/1.1[crlf]Host: [app_host][crlf]Connection: Upgrade[crlf]Upgrade: Websocket[crlf][crlf]",
            "SNI": "lojaempresas.vivo.com.br",
            "TlsIP": "104.18.7.80",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
...
{
      "Name": "OPERADORA VIVO [02]",
      "FLAG": "vivo",
      "Payload": "GET wss://celular.vivo.com.br// HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
      "SNI": "celular.vivo.com.br",
    ...
    {
      "Name": "OPERADORA VIVO [03]",
      "FLAG": "vivo",
      "Payload": "GET wss://beneficios.vivo.com.br/ HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
      "SNI": "beneficios.vivo.com.br",
      "TlsIP": "104.16.123.175",
      "ProxyIP": "",
      "ProxyPort": "443",
      "Info": "Tlsws"
   },
    {
      "Name": "OPERADORA VIVO [04]",
      "FLAG": "vivo",
    ...
    {
      "Name": "OPERADORA VIVO [05]",
      "FLAG": "vivo",
      "Payload": "GET wss://player-api.new.livestream.com// HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
    ...
    },
    {
      "Name": "VIVO EASY 2️",
      "FLAG": "vivo",
      "Payload": "GET wss://support.duolingo.com/ HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: WayNet[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
      "SNI": "support.duolingo.com",
      "TlsIP": "",
      "ProxyIP": "104.18.7.80",
      "ProxyPort": "80",
      "Info": "Proxy"
    },
{
   ...
   "Name": "𝗩𝗜𝗩𝗢 & 𝗧𝗜𝗠",
   "FLAG": "vivo",
   "Payload": "GET wss://bam.nr-data.net HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
   "SNI": "",
   "TlsIP": "",
...
"Name": "𝗩𝗜𝗩𝗢 4𝗚 𝟬3📡",
     ...
     "Name": "𝗖𝗟𝗔𝗥𝗢 𝟱𝗚 𝟬1 📡",
     "FLAG": "claro",
     "Payload": "GET wss://em.launchdarkly.com/ HTTP/1.1[crlf]Host: [app_host][crlf]Connection: upgrade[crlf]Upgrade: Websocket[crlf]Upgrade: ScotTLS[crlf][crlf]",
     "SNI": "em.launchdarkly.com",
     "TlsIP": "clarowing65.storage-cdn77.gq",
     "ProxyIP": "",
     "ProxyPort": "443",
     "Info": "Tlsws"
     },
     ...
     "Name": "𝗖𝗟𝗔𝗥𝗢 𝟱𝗚 𝟬2 📡",
     "FLAG": "claro",
     "Payload": "GET wss://go.launchdarkly.com/ HTTP/1.1[crlf]Host: [app_host][crlf]Connection: upgrade[crlf]Upgrade: Websocket[crlf]Upgrade: ScotTLS[crlf][crlf]",
     ...
     "Name": "𝗖𝗟𝗔𝗥𝗢 𝟱𝗚 𝟬3 📡",
     "FLAG": "claro",
     "Payload": "GET wss://support.launchdarkly.com/ HTTP/1.1[crlf]Host: [app_host][crlf]Connection: upgrade[crlf]Upgrade: Websocket[crlf]Upgrade: ScotTLS[crlf][crlf]",                                "SNI": "support.launchdarkly.com",
      "TlsIP": "em.launchdarkly.com",
      "ProxyIP": "",
      "ProxyPort": "443",
      "Info": "Tlsws"
      },
      ...
      },
      {
        ...
        },
        {
          "Name": "CLARO ON | 01", 
         "FLAG": "CLARO", 
         "Payload": "GET wss://player-api.new.livestream.com HTTP/1.1\nHost: [app_host]\nUpgrade: WebSocket\n\n", 
         "SNI": "player-api.new.livestream.com", 
         "TlsIP": "player-api.new.livestream.com", 
         "ProxyIP": "player-api.new.livestream.com", 
         "ProxyPort": "443", 
         "Info": "Tlsws"
    },
    {
      "Name": "VIVO 07",
            "FLAG": "vivo",
            "Payload": "GET wss://web.vivo.com.br// HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]Connection: Keep-Alive[crlf][crlf]",
            "SNI": "web.vivo.com.br",
            "TlsIP": "104.16.122.175",
            "ProxyIP": "",
            "ProxyPort": "443",
        ...
        },
        {
            ...
            "TlsIP": "gracegardencounseling.com",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
        },
        ...
        },
        {
            "Name": "VIVO 11",
            "FLAG": "vivo",
            "Payload": "GET wss://rapehun.com [protocol][crlf]Host: [app_host][crlf]X-Forwarded-For: [app_host][crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]",
            "SNI": "rapehun.com",
            "TlsIP": "rapehun.com",
            "ProxyIP": "",
            "ProxyPort": "443",
        ...
        },
        {
            "Name": "VIVO 13",
            "FLAG": "vivo",
            "Payload": "GET wss://fitality.gr/ HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf][crlf]",
            "SNI": "fitality.gr",
            "TlsIP": "fitality.gr",
            "ProxyIP": "",
            "ProxyPort": "443",
        ...
        },
        {
            "Name": "VIVO 17",
            "FLAG": "vivo",
            "Payload": "GET ws://vigia.vivo.com.br HTTP/1.1nHost: [app_host]nUpgrade: wsnn",
            "SNI": "vigia.vivo.com.br",
            "TlsIP": "104.16.18.94",
            "ProxyIP": "",
            "ProxyPort": "443",
        ...
        },
        {
            "Name": "VIVO 18",
            "FLAG": "vivo",
            "Payload": "GET wss://tvduck.com/ HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf][crlf]",
            "SNI": "tvduck.com",
            "TlsIP": "tvduck.com",
            "ProxyIP": "",
            "ProxyPort": "443",
        ...
        },
        {
            "Name": "TIM 01 ON",
            "FLAG": "tim",
            "Payload": "GET wss://bam.nr-data.net HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: websocket[crlf][crlf]",
            "SNI": "bam.nr-data.net",
        ...
        },
        {
            "Name": "TIM 02",
            "FLAG": "tim",
            "Payload": "GET wss://blog.alura.com.br HTTP/1.1[lf]Host: [app_host][crlf]Upgrade: websocket[crlf][crlf]",
        ...
        },
        {
            "Name": "TIM 03",
            "FLAG": "tim",
            "Payload": "GET wss://materiais.alura.com.br HTTP/1.1nHost: [app_host]nUpgrade: WebSocketnn",
        ...
        },
        {
            "Name": "TIM 06",
            "FLAG": "tim",
            "Payload": "GET wss://bobcontents.bennuapp.com.br  HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: websocket[crlf][crlf]",
            "SNI": "bobcontents.bennuapp.com.br",
            "TlsIP": "bobcontents.bennuapp.com.br",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
        },
        ...
        },
        {
            "Name": "CLARO CDN 01",
            "FLAG": "claro",
            "Payload": "GET / HTTP/1.1[crlf]Host: [random=d1y9aiwjeg3d6i.cloudfront.net;g6l0sm2t0q.map.azionedge.net;jkbh99lb8h.map.azionedge.net;l2vhknnqo7.map.azionedge.net;q83wbwxnbg.map.azionedge.net][crlf]Connection: Upgrade[crlf]Upgrade: Websocket [crlf][crlf]",
            "SNI": "statics-recarga.claro.com.br",
            "TlsIP": "statics-recarga.claro.com.br",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
        },
        {
            "Name": "CLARO CDN 02",
            "FLAG": "claro",
            "Payload": "GET / HTTP/1.1[crlf]Host: [random=agile.code2.online;g6l0sm2t0q.map.azionedge.net;jkbh99lb8h.map.azionedge.net;l2vhknnqo7.map.azionedge.net;q83wbwxnbg.map.azionedge.net][crlf]Connection: Upgrade[crlf]Upgrade: Websocket [crlf][crlf]",
            "SNI": "hmg-statics-recarga.claro.com.br",
            "TlsIP": "hmg-statics-recarga.claro.com.br",
            "ProxyIP": "",
            "ProxyPort": "443",
            "Info": "Tlsws"
        },
        ...
        },
        {
            "Name": "CLARO 06",
            "FLAG": "claro",
            "Payload": "GET ssl://content.akross.com.br HTTP/1.1[crlf]Host: [app_host][crlf]Upgrade: websocket[crlf][crlf]",
        ...
        },
        {
            "Name": "OI 01",
            "FLAG": "oi",
            "Payload": "GET ws://www.hbogo.com.br HTTP/1.1rnHost: [app_host]rnUpgrade: wsrnrn",
